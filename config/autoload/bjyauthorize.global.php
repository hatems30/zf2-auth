...
//            ],
        ...
        'resource_providers' => [
            \Application\BjyAuthorize\Resource\ObjectRepositoryProvider::class => [
                // class name of the entity representing the role
                'resource_entity_class' => 'Application\Entity\Resource',
                // service name of the object manager
                'object_manager'    => 'doctrine.entitymanager.orm_default',
            ],
            ],
        'rule_providers' => [
            \Application\BjyAuthorize\Rule\ObjectRepositoryProvider::class => [
                // class name of the entity representing the role
                'rule_entity_class' => 'Application\Entity\Rule',
                // service name of the object manager
                'object_manager'    => 'doctrine.entitymanager.orm_default',
            ],
            ],
